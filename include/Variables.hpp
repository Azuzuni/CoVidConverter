...
namespace Variables {
    ...
    inline int width{380}; // Screen Width
    inline int height{38}; // Screen Height

    inline bool useDefaultVideoFPS{true}; // True = Caps limit to video default fps, takes priority over capFPS
